		...
		<div class="tab-content">
			<div class="tab-pane active" id="jogos" role="tabpanel" aria-labelledby="jogos-tab">
				<div class="container">
					...
					<?php  echo form_open('index.php/Cadastro/cadastraJogos'); ?><!--Nome do metodo que cadastra-->
					...
					<div class="col-sm-9">
						<div class="input-group">
							<div class="custom-file">
								<input type="file" class="custom-file-input" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" name="pro_foto">
