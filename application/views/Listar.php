								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											<?php 
											?>
											<p><?php echo "<b>Codigo:</b> ".$rows_computador['com_codigo']; ?></p>
											<p><?php echo "<b>Nome:</b> ".$rows_computador['com_nome']; ?></p>
											<p><?php echo "<b>Descrição:</b> ".$rows_computador['com_descricao']; ?></p>
											<p><?php echo "<b>Marca:</b> ".$imarc[0]->mar_marca; ?></p>
											<p><?php echo "<b>Modelo:</b> ".$imodc[0]->mod_modelo; ?></p>
											<p><?php echo "<b>Arquitetura:</b> ".$rows_computador['com_arquitetura']; ?></p>
											<p><?php echo "<b>Preco: </b>".$rows_computador['com_preco']; ?></p>
										</div>
									</div>
								</div>
							</div>
